...
if(isset($treffer))
{
	...
	else
	{
		...
		<div class="jumbotron">
		  ...
		  <?php $urltoShare = "http://".$_SERVER["HTTP_HOST"].substr($_SERVER["REQUEST_URI"], 0, strpos($_SERVER["REQUEST_URI"], "?")); ?>
		  <a href="https://twitter.com/intent/tweet?button_hashtag=randomReisen&text=Ich%20fahre%20heute%20mit%20dem%20<?php echo $treffer[$zufall][0]["typ"]; ?>%20<?php echo $treffer[$zufall][0]["nummer"]; ?>%20nach%20<?php echo urlencode($treffer[$zufall][1]["name"]); ?>%20<?php echo urlencode($urltoShare); ?>" class="twitter-hashtag-button" daa-url="<?php echo $urltoShare; ?>">Tweet #randomReise</a>
